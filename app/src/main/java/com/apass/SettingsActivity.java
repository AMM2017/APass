...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    static final int REQUEST_CODE_CONFIRM_DELETE = 17;
    ...
    public static class GeneralPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            //кнопка удалить
            Preference deletePref = (Preference) findPreference("notifications_delete");
            deletePref.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                public boolean onPreferenceClick(Preference preference) {
                    Intent intent = new Intent(context, DeleteActivity.class);
                    intent.putExtra("recordList", recordList);
                    startActivityForResult(intent, REQUEST_CODE_CONFIRM_DELETE);
                    return true;
                }
            });
        }
